# Introducing the Standalone HTTP Server Package
...
## What Improved[​](#what-improved "Direct link to What Improved")
...
## Router Setup Before and After[​](#router-setup-before-and-after "Direct link to Router Setup Before and After")
...
## One Handler for a Route Group[​](#one-handler-for-a-route-group "Direct link to One Handler for a Route Group")
...
## Typed Request Binding[​](#typed-request-binding "Direct link to Typed Request Binding")
...
## A Cleaner Direction for HTTP Services[​](#a-cleaner-direction-for-http-services "Direct link to A Cleaner Direction for HTTP Services")
...
For the full API overview, see the [HTTP server package reference](/docs/pr-1/reference/package-httpserver.md).<br /><!-- -->For step-by-step migration details, see the [HTTP server package migration guide](/docs/pr-1/migrations/httpserver-package.md).

**Tags:**

* [gosoline](/docs/pr-1/blog/tags/gosoline.md)
* [httpserver](/docs/pr-1/blog/tags/httpserver.md)
* [framework](/docs/pr-1/blog/tags/framework.md)
* [migration](/docs/pr-1/blog/tags/migration.md)
