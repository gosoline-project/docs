# Identity & Naming Patterns: Flexible, Configuration-Driven Resource Naming
...
## What changed at a glance[​](#what-changed-at-a-glance "Direct link to What changed at a glance")
...
## The new Identity model[​](#the-new-identity-model "Direct link to The new Identity model")
...
## Naming patterns: define once, use everywhere[​](#naming-patterns-define-once-use-everywhere "Direct link to Naming patterns: define once, use everywhere")
...
### The namespace pattern[​](#the-namespace-pattern "Direct link to The namespace pattern")
...
### Concrete example: SQS queues[​](#concrete-example-sqs-queues "Direct link to Concrete example: SQS queues")
...
### Strict placeholder validation[​](#strict-placeholder-validation "Direct link to Strict placeholder validation")
...
For a complete list of all configurable patterns across every service, see the [Naming Patterns reference](/docs/pr-1/reference/naming-patterns.md) and [Naming Patterns fundamentals](/docs/pr-1/fundamentals/naming-patterns.md).

***

## `application.Default()` slimmed down[​](#applicationdefault-slimmed-down "Direct link to applicationdefault-slimmed-down")
...
### Go API[​](#go-api "Direct link to Go API")
...
### Config key renames[​](#config-key-renames "Direct link to Config key renames")
...
### ModelId refactoring[​](#modelid-refactoring "Direct link to ModelId refactoring")
...
See the [Naming Patterns reference](/docs/pr-1/reference/naming-patterns.md#modelid-domain-pattern-canonical-ids) for the full rules and examples.
...
For full step-by-step instructions covering stream input/output config, `mdlsub` publishers, Go code changes, and per-service pattern updates, see the [migration guide](/docs/pr-1/migrations/app-identity-and-naming-patterns.md).

**Tags:**

* [identity](/docs/pr-1/blog/tags/identity.md)
* [naming](/docs/pr-1/blog/tags/naming.md)
* [configuration](/docs/pr-1/blog/tags/configuration.md)
* [breaking-changes](/docs/pr-1/blog/tags/breaking-changes.md)
