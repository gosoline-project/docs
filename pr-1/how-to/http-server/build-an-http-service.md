...
### Handler factory[​](#handler-factory "Direct link to Handler factory")
...
### Bind, BindR, BindN, and BindNR[​](#bind-bindr-bindn-and-bindnr "Direct link to Bind, BindR, BindN, and BindNR")
...
## Binding request data[​](#binding-request-data "Direct link to Binding request data")
...
### Query string and form parameters[​](#query-string-and-form-parameters "Direct link to Query string and form parameters")
...
### JSON request body[​](#json-request-body "Direct link to JSON request body")
...
### Combining multiple sources[​](#combining-multiple-sources "Direct link to Combining multiple sources")
...
### Auto-detection logic[​](#auto-detection-logic "Direct link to Auto-detection logic")
...
### BindR — access the raw request[​](#bindr--access-the-raw-request "Direct link to BindR — access the raw request")
...
### Resolve the client IP[​](#resolve-the-client-ip "Direct link to Resolve the client IP")
...
* [Stream with Server-Sent Events](/docs/pr-1/how-to/http-server/stream-with-sse.md) — push real-time updates to clients
* [Serve a frontend](/docs/pr-1/how-to/http-server/serve-a-frontend.md) — embed and serve a SPA from your Go binary
* [Configure your server](/docs/pr-1/how-to/http-server/configure-your-server.md) — timeouts, compression, multiple servers
* [Add middleware](/docs/pr-1/how-to/http-server/add-middleware.md) — custom middleware, CORS
* [Real-world example](/docs/pr-1/how-to/http-server/real-world-example.md) — patterns from production applications
