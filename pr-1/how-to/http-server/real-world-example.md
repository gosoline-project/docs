...
## Module registration[​](#module-registration "Direct link to Module registration")
...
## Route organization with groups[​](#route-organization-with-groups "Direct link to Route organization with groups")
...
## Shared input types[​](#shared-input-types "Direct link to Shared input types")
...
## Mixed binding sources[​](#mixed-binding-sources "Direct link to Mixed binding sources")
...
type AuthenticatedTaskInput struct {
...
## SSE for real-time updates[​](#sse-for-real-time-updates "Direct link to SSE for real-time updates")
...
## Summary of patterns[​](#summary-of-patterns "Direct link to Summary of patterns")
