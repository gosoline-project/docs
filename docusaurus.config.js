...
const organizationName = "gosoline-project";
const projectName = "docs";

// Determine search mode: 'algolia' (production) or 'local' (preview/dev)
const searchMode = process.env.SEARCH_MODE || 'algolia';
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/gosoline-project/docs/tree/main/',
        },
        blog: {
          routeBasePath: '/blog',
          ...
          editUrl: 'https://github.com/gosoline-project/docs/tree/main/',
        },
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/gosoline-project/docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
