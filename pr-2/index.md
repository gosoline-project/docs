...
[Get started](/docs/pr-2/category/http-server/.md)

Message Queues

Process asynchronous messages from Kafka, Redis, or any other queuing or streaming system.

[Get started](/docs/pr-2/getting-started/create-a-consumer/.md)

Kernel Module

Implement a kernel module with which you can do anything, using gosoline's logging, configuration, and other solutions.

[Get started](/docs/pr-2/getting-started/create-an-application/.md)

<br />

Want to skip the guided walkthroughs and get straight to the information? Check out our [API reference docs](/docs/pr-2/category/reference/.md).
