...
## What is fingers-crossed logging?[​](#what-is-fingers-crossed-logging "Direct link to What is fingers-crossed logging?")
...
## Enable sampling[​](#enable-sampling "Direct link to Enable sampling")
...
### Application Options[​](#application-options "Direct link to Application Options")
...
## Usage in HTTP Services[​](#usage-in-http-services "Direct link to Usage in HTTP Services")
...
### What gets flushed (and when)[​](#what-gets-flushed-and-when "Direct link to What gets flushed (and when)")
...
## Usage in Stream Consumers[​](#usage-in-stream-consumers "Direct link to Usage in Stream Consumers")
...
### Decision flow[​](#decision-flow-1 "Direct link to Decision flow")
...
### What gets flushed (and when)[​](#what-gets-flushed-and-when-1 "Direct link to What gets flushed (and when)")
...
### Key API Methods[​](#key-api-methods "Direct link to Key API Methods")
...
### "I don't see any logs"[​](#i-dont-see-any-logs "Direct link to \"I don't see any logs\"")
...
### "Why did it flush?"[​](#why-did-it-flush "Direct link to \"Why did it flush?\"")
