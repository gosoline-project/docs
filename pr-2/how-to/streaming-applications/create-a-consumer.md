...
For a first walkthrough, see [Create a consumer](/docs/pr-2/getting-started/create-a-consumer/.md). This guide focuses on the current typed API and operational behavior.
...
* [Test your consumer](/docs/pr-2/getting-started/testing/test-your-consumer/.md)
