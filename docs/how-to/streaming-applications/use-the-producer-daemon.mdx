---
sidebar_position: 4
title: Use the producer daemon
---

import CodeBlock from '@theme/CodeBlock';
import Main from "!!raw-loader!./src/producer-daemon/main.go";
import Config from "!!raw-loader!./src/producer-daemon/config.dist.yml";
...
## Enable and register the daemon
...
Kafka does not support Gosoline aggregation in the producer daemon. Kafka's own producer performs batching and compression, and its `max_batch_size` and `max_batch_bytes` settings override daemon batch limits. See [general Kafka usage](/how-to/kafka/general#producer-daemon-usage).
