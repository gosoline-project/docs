...
- [Create a consumer](/how-to/streaming-applications/create-a-consumer/) to process the produced models
- [Use the producer daemon](/how-to/streaming-applications/use-the-producer-daemon/) to buffer, batch, or aggregate writes
