...
- [Stream with Server-Sent Events](/how-to/http-server/stream-with-sse/) — push real-time updates to clients
- [Serve a frontend](/how-to/http-server/serve-a-frontend/) — embed and serve a SPA from your Go binary
- [Configure your server](/how-to/http-server/configure-your-server/) — timeouts, compression, multiple servers
- [Add middleware](/how-to/http-server/add-middleware/) — custom middleware, CORS
- [Real-world example](/how-to/http-server/real-world-example/) — patterns from production applications
