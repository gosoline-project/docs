...
### [Suite](https://github.com/justtrackio/gosoline/blob/v0.63.7/pkg/test/suite/suite.go#L11)
...
### [Run()](https://github.com/justtrackio/gosoline/blob/v0.63.7/pkg/test/suite/run.go#L30)
