...
This guide focuses only on the sampling packages. If you want to see how sampling interacts with buffering logs on errors, read: [Sampling & fingers-crossed](/docs/pr-4/how-to/logging/sampling-and-fingers-crossed/.md).
