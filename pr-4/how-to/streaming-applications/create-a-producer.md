...
* [Create a consumer](/docs/pr-4/how-to/streaming-applications/create-a-consumer/.md) to process the produced models
* [Use the producer daemon](/docs/pr-4/how-to/streaming-applications/use-the-producer-daemon/.md) to buffer, batch, or aggregate writes
