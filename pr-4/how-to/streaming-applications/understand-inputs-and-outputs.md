...
For Kafka-specific behavior and schema registry configuration, see the [Kafka guides](/docs/pr-4/how-to/kafka/general/.md).

## What's next?[​](#whats-next "Direct link to What's next?")

* [Create a producer](/docs/pr-4/how-to/streaming-applications/create-a-producer/.md)
* [Create a consumer](/docs/pr-4/how-to/streaming-applications/create-a-consumer/.md)
* [Use the producer daemon](/docs/pr-4/how-to/streaming-applications/use-the-producer-daemon/.md)
