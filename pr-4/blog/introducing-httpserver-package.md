...
For the full API overview, see the [HTTP server package reference](/docs/pr-4/reference/package-httpserver/.md).<br /><!-- -->For step-by-step migration details, see the [HTTP server package migration guide](/docs/pr-4/migrations/httpserver-package/.md).

**Tags:**

* [gosoline](/docs/pr-4/blog/tags/gosoline/.md)
* [httpserver](/docs/pr-4/blog/tags/httpserver/.md)
* [framework](/docs/pr-4/blog/tags/framework/.md)
* [migration](/docs/pr-4/blog/tags/migration/.md)
