...
For a complete list of all configurable patterns across every service, see the [Naming Patterns reference](/docs/pr-3/reference/naming-patterns/.md) and [Naming Patterns fundamentals](/docs/pr-3/fundamentals/naming-patterns/.md).
...
See the [Naming Patterns reference](/docs/pr-3/reference/naming-patterns/.md#modelid-domain-pattern-canonical-ids) for the full rules and examples.
...
For full step-by-step instructions covering stream input/output config, `mdlsub` publishers, Go code changes, and per-service pattern updates, see the [migration guide](/docs/pr-3/migrations/app-identity-and-naming-patterns/.md).

**Tags:**

* [identity](/docs/pr-3/blog/tags/identity/.md)
* [naming](/docs/pr-3/blog/tags/naming/.md)
* [configuration](/docs/pr-3/blog/tags/configuration/.md)
* [breaking-changes](/docs/pr-3/blog/tags/breaking-changes/.md)
