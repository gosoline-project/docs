...
For the full API overview, see the [HTTP server package reference](/docs/pr-3/reference/package-httpserver/.md).<br /><!-- -->For step-by-step migration details, see the [HTTP server package migration guide](/docs/pr-3/migrations/httpserver-package/.md).

**Tags:**

* [gosoline](/docs/pr-3/blog/tags/gosoline/.md)
* [httpserver](/docs/pr-3/blog/tags/httpserver/.md)
* [framework](/docs/pr-3/blog/tags/framework/.md)
* [migration](/docs/pr-3/blog/tags/migration/.md)
