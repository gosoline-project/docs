...
* [Stream with Server-Sent Events](/docs/pr-3/how-to/http-server/stream-with-sse/.md) — push real-time updates to clients
* [Serve a frontend](/docs/pr-3/how-to/http-server/serve-a-frontend/.md) — embed and serve a SPA from your Go binary
* [Configure your server](/docs/pr-3/how-to/http-server/configure-your-server/.md) — timeouts, compression, multiple servers
* [Add middleware](/docs/pr-3/how-to/http-server/add-middleware/.md) — custom middleware, CORS
* [Real-world example](/docs/pr-3/how-to/http-server/real-world-example/.md) — patterns from production applications
