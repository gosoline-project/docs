...
This handler struct stores the log `channel`. To use your handler, you must implement the required methods of the [`Handler`](/docs/pr-3/reference/package-log/.md#handler) interface.
...
* [Use loggers](/docs/pr-3/how-to/logging/use-loggers/.md)
* [API reference for the log package](/docs/pr-3/reference/package-log/.md)
