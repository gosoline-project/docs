...
* [Configure a logger with gosoline](/docs/pr-3/how-to/logging/use-loggers/.md#implement-a-logger-with-an-app-configuration)
* [API reference for the cfg package](/docs/pr-3/reference/package-cfg/.md)
